                ...
                <div class="container-fluid">
                    ...
                    <div class="card border-0 form-card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('students_register.store') }}" enctype="multipart/form-data" class="row g-3">
                                @csrf
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body text-center">
                                            ...
                                            <p>We will send a confirmation email to your email address. Please check your email for further instructions.</p>
                                        </div>
