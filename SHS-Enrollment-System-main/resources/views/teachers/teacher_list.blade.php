                    ...
                    <div class="card border-0">
                        <div class="card-header">
                            ...
                            <nav class="navbar bg-body-light">
                                <div class="container-fluid">
                                    <form role="search" method="GET" action="{{ route('teachers.index') }}">
                                        ...
                                        <a href="{{ route('teachers.create') }}" class="btn btn-info ms-2">
                                                ...
                                                <td>
                                                    ...
                                                    <form action="{{ route('teachers.destroy', $teacher->TeacherID) }}" 
                                                      ...
                                                      <button type="button" class="btn btn-outline-danger btn-sm" 
                                                              onclick="showDeleteConfirmation({{ $teacher->TeacherID }})">
                                                              <i class="fa-regular fa-trash-can"></i> Delete
                                                      </button>
                                                      
                                                      <div class="toast position-fixed top-0 start-50 translate-middle-x" 
                                                           style="z-index: 1000;" 
                                                           id="deleteToast{{ $teacher->TeacherID }}" 
                                                           role="alert" 
                                                           aria-live="assertive" 
                                                           aria-atomic="true">
                                                          <div class="toast-body">
                                                              Are you sure you want to delete this Teachers Information?
