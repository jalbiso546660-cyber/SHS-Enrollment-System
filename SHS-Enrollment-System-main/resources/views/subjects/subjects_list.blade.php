                            ...
                            <nav class="navbar bg-body-light">
                                <div class="container-fluid">
                                    <form role="search" method="GET" action="{{ route('students.index') }}">
                                        ...
                                        <a href="{{ route('subjects.create') }}" class="btn btn-info ms-2">
                                        ...
                                        @foreach($subjects as $subject)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="{{ route('subjects.destroy', $subject->SubjectID) }}" 
                                                        method="POST" 
                                                        style="display:inline">
                                                      @csrf
                                                      @method('DELETE')
                                                      <button type="button" class="btn btn-outline-danger btn-sm" 
                                                              onclick="showDeleteConfirmation({{ $subject->SubjectID }})">
                                                              <i class="fa-regular fa-trash-can"></i> Delete
                                                      </button>
                                                      
                                                      <div class="toast position-fixed top-0 start-50 translate-middle-x" 
                                                           style="z-index: 1000;" 
                                                           id="deleteToast{{ $subject->SubjectID }}" 
                                                           role="alert" 
                                                           aria-live="assertive" 
                                                           aria-atomic="true">
