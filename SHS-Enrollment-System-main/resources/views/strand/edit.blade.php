                        ...
                        <div class="card normal-card">
                            ...
                            <form method="POST" action="{{ route('strand.store') }}" enctype="multipart/form-data" class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="Strand_Name" class="form-control" required value="{{ $strand->Strand_Name }}">
                                </div>

                                <div class="col-md-4">
                                    <label class="form-label">Description</label>
                                    <input type="text" name="description" class="form-control" required value="{{ $strand->description }}">
                                </div>
